...
function PANEL:CreateItem(itemKey, itemInfo)
    ...
    modelPanel.OnMousePressed = function(self2, keyCode)
        itemPanel:OnMousePressed(keyCode)
    end

    modelPanel.OnMouseReleased = function(self2, keyCode)
        itemPanel:OnMouseReleased(keyCode)
    end
